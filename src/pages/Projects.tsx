  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <Loader2Icon className="size-7 animate-spin text-gray-400 dark:text-violet-200" />
      </div>
    );
  }
  ...
  return project ? (
    <div className="flex flex-col h-screen w-full bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      <div className="flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 border-b border-gray-200 dark:border-gray-800">
        ...
        {/* middle */}
        <div className="hidden sm:flex gap-2 bg-gray-100 dark:bg-gray-950 p-1.5 rounded-md">
          <SmartphoneIcon
        ...
        <div className="flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm">
          <button
            onClick={saveProject}
            disabled={isSaving}
            className="max-sm:hidden bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors border border-gray-300 dark:border-gray-700"
          >
            {isSaving ? (
          ...
          <Link
            ...
            className="flex items-center gap-2 px-4 py-1 rounded sm:rounded-sm border border-gray-300 dark:border-gray-700 hover:border-gray-400 transition-colors"
          >
